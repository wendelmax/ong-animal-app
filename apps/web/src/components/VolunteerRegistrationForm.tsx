...
export function VolunteerRegistrationForm({ token }: { token: string }) {
  ...
  const submit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    if (statement !== ACCEPTANCE_STATEMENT || !files.PERSONAL_PHOTO || !files.IDENTITY_DOCUMENT) { setError('Aceite o termo e envie os dois arquivos obrigatórios.'); return }
