      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li><Link href="/adocao-responsavel" className="hover:text-brand-orange transition-colors">Adoção Responsável</Link></li>
              <li><Link href="/como-ajudar" className="hover:text-brand-orange transition-colors">Como Ajudar</Link></li>
              <li><Link href="/transparencia" className="hover:text-brand-orange transition-colors">Transparência</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li className="flex items-start gap-3">
                <span>✉️</span> viralatinhas@viralatinhas.com
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-zinc-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <p className="text-xs text-zinc-600">
            Associação Viralatinhas de Sumaré - Sumaré/SP
          </p>
        </div>
      </div>
    </footer>
